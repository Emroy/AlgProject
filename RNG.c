...
int integerUniform(int n) /* Συνάρτηση δημιουργίας ψευδοτυχαίων ακεραίων με ομοιόμορφη κατανομή. */
{
	...
	{
	    return (rand()%n); /* Αν n=1 τότε δημιουργούνται ψευδοτυχαίοι φυσικοί στο διάστημα [0,RAND_MAX] διαφορετικά δημιουργούνται ψευδοτυχαίοι φυσικοί στο διάστημα [0,n-1]. */
	}
}
